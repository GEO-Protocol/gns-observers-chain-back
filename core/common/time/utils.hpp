...
#ifndef GNS_OBSERVERS_CHAIN_BACK_TIME_UTILS_H
#define GNS_OBSERVERS_CHAIN_BACK_TIME_UTILS_H
...
{
    Duration duration = nowUTC() - DateTime(boost::gregorian::date(1970,1,1));
    return duration.total_microseconds();
}

#endif //GNS_OBSERVERS_CHAIN_BACK_TIME_UTILS_H
